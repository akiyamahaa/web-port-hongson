    ...
    <div className="mt-12 pb-32">
      ...
      <div className="mt-32">
        <Flipbook
          ...
          year="2023"
          content="Lorem ipsum dolor sit amet consectetur. Enim dignissim felis egestas feugiat. Vel volutpat blandit pharetra fermentum odio ac tortor a."
          bookIframe={
            <iframe
              scrolling="no"
      ...
      <div className="mt-32">
        <Flipbook
          ...
          year="2023"
          content="A book provided the basics and advances of digital devices for people that have difficulties using them"
          bookIframe={
            <iframe
              scrolling="no"
              className="bg-background w-full h-[1000px] 
